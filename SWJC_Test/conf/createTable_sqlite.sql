...
insert into cdr_data(site_number, report_time, deepness, temperature, battery_level)
values('DF00000001', '1804011800', 23.33, 23.22, 81);

insert into cdr_data(site_number, report_time, deepness, temperature, battery_level)
values('DF00000002', '1804031900', 34.33, 23.22, 81);

insert into cdr_data(site_number, report_time, deepness, temperature, battery_level)
values('DF00000003', '1804051100', 44.33, 23.22, 81);

insert into cdr_data(site_number, report_time, deepness, temperature, battery_level)
values('DF00000004', '1804101300', 12.33, 23.22, 81);

insert into cdr_data(site_number, report_time, deepness, temperature, battery_level)
values('DF00000005', '1804151500', 22.33, 23.22, 81);

insert into cdr_data(site_number, report_time, deepness, temperature, battery_level)
values('DF00000006', '1804212110', 77.33, 23.22, 81);
